var cn1688 = function () {
    ...
    self.getProduct = function () {
        ...
        prod.getProductProperties = function (product) {
            ...
            if (properties) {
                product.propertiesType = properties.type.slice(0, -1);
                product.propertiesName = properties.name.slice(0, -1);
                product.propertiesImage = properties.images.slice(0, -1);
            }
            return product;
        };
        ...
        prod.getInputQuantity = function (product) {
            ...
            if (skuElems && skuElems.length > 0) {
                if (product.propertiesType) {
                    product.propertiesType += ";";
                }
                if (skuElems.find('.obj-title .hidden').length > 0) {
                    product.propertiesType += skuElems.find('.obj-title .hidden').text();
                } else {
                    product.propertiesType += skuElems.find('.obj-title').text();
                }
                skuElems.find('table.table-sku tr').each(function () {
                    ...
                    var property = product.propertiesName;
                    if (name && price && count > 0 && amount > 0 && map) {
                        ...
                        if (image) {
                            if (p.propertiesImage) {
                                p.propertiesImage += ";"
                            }
                            p.propertiesImage += (JSON.parse(image)).preview;
                        }
                        p.propertiesId = p.propertiesName;
                ...
                if (skuElems && skuElems.length) {
                    ...
                    product.propertiesType += $(".spu-content li.opt-li .d-header").text();
                    ...
                    product.propertiesType += ";" + $("#J_DetailInside .obj-amount .d-title .hidden").text();
        ...
        prod.init = function () {
            ...
            if (!self.first) {
                ...
                if (product.propertiesType && product.propertiesType.indexOf(";") === 0) {
                    product.propertiesType = product.propertiesType.slice(1);
                }
            } else {
